...
const { CreatePublication, AllPublication, deletePublication, updatePublication, insertPublicationPicture, AllPublicationById, addLike, dislike, GetPublicationByUserId, AllPublications } = require("../controllers/ControllerPublication");
...
router.get('/Allpublications', AllPublications)
