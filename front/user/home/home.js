...
<figure class="rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
  ...
  <img src="http://localhost:3555/uploads/${publication.image}">
 <button onclick="redirectionPublication('${publication._id}')">
  ...
  <div class="flex justify-between ">
    <div class="interaction m-2 ">
        <button onclick="like()" class="m-2"><i class="fa-solid fa-heart  "></i></button>
        <button onclick="commenter()"><i class="fa-solid fa-comments"></i></button>
    </div>
 
    <div class="btnCrud  m-2">
        <button onclick="modifier('${publication._id}')"class="m-2"><i class="fa-solid fa-pen"></i></button>
        <button onclick="deletePublication('${publication._id}')"><i class="fa-solid fa-trash text-red-600 "></i></button>
        </div>
    
  </div>
  <div class="commentaire hidden max-w-2xl left-1/4 bottom-0 gap-8 text-sm leading-6 text-gray-900 xl:mx-0 xl:max-w-none">
